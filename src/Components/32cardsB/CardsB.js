        ...
        <div className="col-lg-8 p-1">
          <div className="thirtytwoB-game-div pt-2 p-2">
            ...
            <div className="card">
              <div className="row">
                ...
                <div className="col-lg-6">
                  ...
                  <div className="cardB-table-inner-row row">
                    <div className="col-6 d-flex align-items-center ps-2">
                      PLAYER 8
                    </div>
                    <div className="col-3 d-flex align-items-center justify-content-center px-2">
                      ...
                      >
                        Suspended
                        <p className="zero my-auto">0</p>
                      </button>
                    </div>
                    <div className="col-3 d-flex align-items-center justify-content-center ">
                      <button className="layB-btn">
                        Suspended
                        <p className="zero my-auto">0</p>
                      </button>
                    </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="table-h-div row">
                    ...
                    <div className="col-3 d-flex align-items-center justify-content-center px-2"></div>
                    <div className="col-3 d-flex align-items-center justify-content-center "></div>
                  </div>
                  <div className="card-table-inner-row row">
                    <div className="col-6 d-flex align-items-center ps-2">
                      8 & 9 Total <span className="fail ms-2"> 0</span>
                    </div>
                    <div className="col-lg-6 col-md-3 col-sm-3 col-6 d-flex align-items-center justify-content-center px-2">
                      <button
                        onClick={() => {
                          setShowdataModal(true);
                        }}
            ...
            <div className="card digit-card">
              <div className="digits-card-h d-flex justify-content-center align-items-center">
                LAST DIGIT OF TOTAL OF 1st FOUR CARDS
              </div>
              <div className="zero-div d-flex justify-content-center algin-items-center pt-1">
                0
              </div>
