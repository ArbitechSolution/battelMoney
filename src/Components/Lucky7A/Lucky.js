                      ...
                      <div className="  button-column  pt-1">
                        ...
                        <div>
                          <button
                            ...
                            className="blue-grey-btn mx-auto d-flex justify-content-center align-items-center"
                          >
                            RED
                            <div className=" card-symbol-div d-flex align-items-center justify-content-center ms-1">
                              <img
                                className="card-symbol-img"
                                src={diamond}
                                alt=""
                              />
                            </div>
