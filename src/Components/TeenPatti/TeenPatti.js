      ...
      <div className="data-modal-container">
        ...
        <div className="modal-footer row mt-1">
          ...
          <div className="col-7 py-2">
              <button onClick={()=>{setShowModal(false)}} className="mcb ">
                  Cancel
              </button>
      ...
      <>
        ...
        <div className="results-modal-container bg-dark">
          ...
          <div>
            ...
            <div className="d-flex justify-content-center mt-2">
              <div className="player-a-div  ">
               <div className="d-flex justify-content-between"><div className="text-center">Player B</div><FaTrophy className="trophy-icon" /></div>
          ...
          <div className="teenpatti-game-div pt-2 p-2">
            ...
            <div className="card  teenpatti-game-card mt-1">
              <div className="row">
                <div className="col-10">
                  ...
                  <div className="player-a-div mt-1">
                    Player B
                    <div className="d-flex">
                      <div className="gamecard-div mx-1">
                      ...
                      <div className="gamecard-div mx-1">
                        <img src={d} className="img-fluid" alt="a" />
                      </div>
                      <div className="gamecard-div mx-1">
                        <img src={e} className="img-fluid" alt="a" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="card-table-inner-row row">
                ...
                <div className="col-2 d-flex align-items-center justify-content-center px-2">
                  <button onClick={()=>{setShowModal(true)}} className="back-btn">Suspended</button>
                </div>
                <div className="col-2 d-flex align-items-center justify-content-center ">
                  <button  className="lay-btn">Suspended</button>
                </div>
            ...
            <div className="Results-table">
              ...
              <div className="card rst-card py-1 d-flex">
                <div className="rst-row d-flex">
                  ...
                  <div  onClick={() => {
                      setShowresultModal(true);
                    }} className="rst-btn ms-1">A</div>
                  <div  onClick={() => {
                      setShowresultModal(true);
                    }} className="rst-btn ms-1">A</div>
                  <div  onClick={() => {
                      setShowresultModal(true);
                    }}className="rst-btn ms-1">B</div>
                  <div  onClick={() => {
                      setShowresultModal(true);
                    }} className="rst-btn ms-1">A</div>
                  <div  onClick={() => {
